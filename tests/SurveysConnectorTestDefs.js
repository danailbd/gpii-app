...
var triggersFixture = fluid.require("%gpii-app/tests/fixtures/surveys/triggers.json"),
    surveyFixtures = fluid.require("%gpii-app/tests/fixtures/surveys/surveys.json");
...
fluid.defaults("gpii.tests.app.simpleTriggersServer", {
    ...
    components: {
        contentRouter: {
            ...
            options: {
                path:    "/surveys",
                content: "%gpii-app/tests/fixtures/surveys/"
            }
        }
    }
});
...
var noUserTriggersSequence = [
    { // Survey triggers are received with key in
        ...
        args: [
            "The triggers fixture is correctly received",
            triggersFixture,
            "{arguments}.0"
        ]
    },
